...
?>
<head>
  <title>DENR-R8 DVTS | For Actual Credit DV</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>For Actual Credit DV Table</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">For Actual Credit DV Table</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                ...
                <div class="col-12 col-sm-12">
                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" href="for-actual-credit-dv.php">For Actual Credit DV's</a>
                        </li>
                    </ul>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php 
                                if ($user_role == 1) {
                                    ...
                                    LEFT JOIN tbl_admin assignee ON a.t_user_id = assignee.user_id
                                    LEFT JOIN payee c ON a.payee_sms_id = c.payee_sms_id
                                    WHERE a.t_department_id = $department_id AND a.status = 9
                                    ORDER BY a.task_id DESC";
                                }
                                $info = $obj_admin->manage_all_info($sql);
                                $serial  = 1;
